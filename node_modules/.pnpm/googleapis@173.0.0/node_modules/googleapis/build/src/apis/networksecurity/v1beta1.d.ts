...
export declare namespace networksecurity_v1beta1 {
 ...
 (       */
    ...
    export interface Schema$AuthzPolicy {
         ...
         */
        networkRules?: Schema$AuthzPolicyAuthzRule[];
        /**
    ...
    export class Resource$Organizations$Locations {
         ...
         *
         *   // Do the magic
         *   const res = await networksecurity.organizations.locations.get({
         ...
         *
         *   // Do the magic
         *   const res = await networksecurity.organizations.locations.list({
    ...
    export class Resource$Organizations$Locations$Addressgroups {
         ...
         *   // Do the magic
         *   const res =
         *     await networksecurity.organizations.locations.addressGroups.testIamPermissions(
         *       {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        testIamPermissions(params: Params$Resource$Organizations$Locations$Addressgroups$Testiampermissions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        testIamPermissions(params?: Params$Resource$Organizations$Locations$Addressgroups$Testiampermissions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleIamV1TestIamPermissionsResponse>>;
        testIamPermissions(params: Params$Resource$Organizations$Locations$Addressgroups$Testiampermissions, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        testIamPermissions(params: Params$Resource$Organizations$Locations$Addressgroups$Testiampermissions, options: MethodOptions | BodyResponseCallback<Schema$GoogleIamV1TestIamPermissionsResponse>, callback: BodyResponseCallback<Schema$GoogleIamV1TestIamPermissionsResponse>): void;
        testIamPermissions(params: Params$Resource$Organizations$Locations$Addressgroups$Testiampermissions, callback: BodyResponseCallback<Schema$GoogleIamV1TestIamPermissionsResponse>): void;
    ...
    export interface Params$Resource$Organizations$Locations$Addressgroups$Testiampermissions extends StandardParameters {
        /**
         * REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
         */
        resource?: string;
